class FederalIncomeTax{
  ...
  public double computeTax(int status, double income){
    double tax = 0;
    if (status == 0) { // Compute tax for single filers
      ...
      if (income <= 16700)
        ...
        tax = 16700 * 0.10 + (67900 - 16700) * 0.15 +
        (137050 - 67900) * 0.25 + (171550 - 137050) * 0.28 +
        (372950 - 171550) * 0.33 + (income - 372950) * 0.35;
    }
      ...
      if (income <= 8350)
        ...
        tax = 8350 * 0.10 + (33950 - 8350) * 0.15 +
        (68525 - 33950) * 0.25 + (171550 - 68525) * 0.28 +
        (186475 - 171550) * 0.33 + (income - 186475) * 0.35;
    }
