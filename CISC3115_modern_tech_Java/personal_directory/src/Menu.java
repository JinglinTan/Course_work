public class Menu {
    public static void mainMenu() {
        ...
        System.out.println("3: List entries by first name");
        System.out.println("4: List entries by Last name");
        System.out.println("5: Runtime test(please force exit without saving after testing, " +
                "this method will generate random entries with no removing)");
    ...
    public static void searchStudentMenu(boolean callFromSearchEntry) {
        ...
        System.out.println("5: Search student by mentor's last name");
        System.out.println("Please enter a number of option:");
    }
    ...
    public static void studentFunctionMenu() {
        System.out.println("0: Back to main menu");
        System.out.println("1: Add a mentor to selected student");
        System.out.println("2: Remove a ping from selected student");
        System.out.println("Please enter a number of option:");
    }

    public static void mentorFunctionMenu() {
        System.out.println("0: Back to main menu");
        System.out.println("1: Add a mentee to selected mentor");
        System.out.println("2: Ping a student from selected mentor");
        System.out.println("Please enter a number of option:");
    }
}
